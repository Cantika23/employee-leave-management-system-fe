...
export default function Employees() {
  ...
  // Hanya Administrator yang boleh mengubah role akun jadi Admin
  // dan mereset kata sandi akun HR/Manager/karyawan lain.
                ...
                <div className="employee-form-grid">
                  ...
                  <div className="employee-field">
                    ...
                    >
                      ...
                      {/* Hanya Admin yang boleh menetapkan role Admin */}
                      {isAdmin && (
                        <option value="admin">
                          Admin
                        </option>
      ...
      {resetTarget && (
        ...
        >
          ...
          >
            ...
            <div className="confirm-desc">
              Kata sandi lama akan diganti dengan
              kata sandi acak baru. Karyawan perlu
              memakai kata sandi baru ini untuk
              masuk selanjutnya.
            </div>
      ...
      {resetResult && (
        ...
        >
          ...
          >
            ...
            <div className="confirm-desc">
              Catat &amp; sampaikan kata sandi ini
              secara manual — kata sandi ini hanya
              ditampilkan sekali dan tidak bisa
              dilihat lagi setelah ditutup.
            </div>
              ...
              <button
                ...
                onClick={() => {
                  navigator.clipboard
                    ...
                    .then(() =>
                      push('Kata sandi disalin.', 'success'),
                    )
                    .catch(() => {})
                }}
              >
