...
export default function Profile() {
  ...
  async function onSubmitPassword(event) {
    ...
    if (passwordForm.password.trim().length < 6) {
      push('Password baru minimal 6 karakter.', 'error')
      return
    }
    ...
    try {
      ...
      push('Password berhasil diganti.')
      setPasswordForm({ password: '', passwordConfirmation: '' })
      setShowPasswordForm(false)
    } catch {
      push('Gagal mengganti password.', 'error')
    } finally {
    ...
    <div>
      ...
      <div className="form-grid">
        ...
        <section className="card panel">
          ...
          >
            <h2 style={{ fontSize: '1.05rem', margin: 0 }}>Ganti Password</h2>
            {!showPasswordForm && (
              <button
                type="button"
